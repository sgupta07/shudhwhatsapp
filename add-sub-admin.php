...
<head>
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = $_POST['status'];
        $sql = "INSERT INTO `user_details`(`company_name`, `user_name`, `full_name`, `mobile`, `email`, `password`, `user_profile`,`user_type`, `status`, `creates_by`, `created`)";
        $sql .= "VALUES ('$company','$username','$fullname','$mobileno','$email','$password','$user_profile','2','$status','$user_id',now())";
        // $insert_user = mysqli_query($conn, $sql);
        if ($conn->query($sql) === TRUE) {
            $last_id = $conn->insert_id;
            mysqli_query($conn, "UPDATE `user_details` SET `sub_admin_id`='$last_id' WHERE `id`='$last_id'");
            echo "<script>window.location.href = 'admin-sub-admin.php?msg=1';";
            echo "</script>";
        } else {
...
<body class="skin-green sidebar-mini" style="height: auto;">
                ...
                <div class="content-wrapper" style="min-height: 851px; padding: 15px;">
                    <section class="content">
                        <div class="box box-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <h4><i class="fa fa-pencil"></i> &nbsp; Manage Sub Admin</h4>
                                </div>
                                <div class="col-md-4">
                                    <a href="javascript:history.back()" class="btn btn-primary pull-right"><i class="fa fa-close"></i> cancel</a>
                                    <a href="admin-sub-admin.php?action=add" style="margin-right:5px;" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Sub Admin</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <form id="fileinfo" method="post" name="fileinfo" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" onkeyup="return forceLower(this);" style="width: 100%;" required placeholder="Enter userName" name="username" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="email" onkeyup="return forceLower(this);" style="width: 100%;" required placeholder="Enter email id" name="email" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" style="    width: 100%;" placeholder="Enter mobileno" required name="mobileno" value="">
                                                    </div>
                                                </div>
    ...
    width: 84%;" placeholder="Enter password" name="password" id="pwd" required value="">

                                            ...
                                            <table id="example1" class="table table-bordered table-striped ">
                                                ...
                                                <tbody> <?php
                                                        if (isset($_GET['id']) && isset($_GET['status'])) {
                                                            ...
                                                            $query = '';
                                                            if ($status == 1) {
                                                                $query = "UPDATE `user_details` SET `Inactive`='0' WHERE `User_ID`='$id'";
                                                            } else {
                                                                $query = "UPDATE `user_details` SET `Inactive`='1' WHERE `User_ID`='$id'";
                                                            }
												...
												//	die();
													if($_SESSION['user_type']==2){
														  $query = "SELECT * FROM `user_details` where user_type ='3' and sub_admin_id='" . $_SESSION['User_ID'] . "'  order by id desc";
													}else{
													  $query = "SELECT * FROM `user_details` where user_type ='3' and creates_by='" . $_SESSION['User_ID'] . "'  order by id desc";
													}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="clientList">
                                                                <a data-toggle="tooltip" title="Edit" href="reseller.php?action=edit&uniqueid=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>

                                                                <a data-toggle="tooltip" title="Credit Update" href="reseller.php?action=credit&uniqueid=<?php echo $row['id']; ?>" class="btn btn-warning"><i class="fa fa-comment"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>

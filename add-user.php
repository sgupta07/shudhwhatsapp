...
<head>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql .= "VALUES ('$company','$username','$fullname','$mobileno','$email','$password','$user_profile','4','$status','$user_id','$sub_admin_id',now())";
        $insert_user = mysqli_query($conn, $sql);
        if (!$insert_user) {
            die('QUERY FAILD post' . mysqli_error($conn));
        } else {
            //window.location.href = 'dashboard.php';alert('User Add successfully');
            echo "<script>window.location.href = 'user.php?msg=1';";
            echo "</script>";
        }
    } ?>
</head>
                                        ...
                                        <form id="fileinfo" method="post" name="fileinfo" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" required onkeyup="return forceLower(this);" style="width: 100%;" placeholder="Enter userName" name="username" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="email" required onkeyup="return forceLower(this);" style="width: 100%;" placeholder="Enter email id" name="email" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" required style="width: 100%;" placeholder="Enter mobileno" name="mobileno" value="">
                                                    </div>
                                                </div>

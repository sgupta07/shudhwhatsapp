                            ...
                            <div class="box-body campaign-view">
                                ...
                                <div class="col-sm-6 border-left newfilter_table">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="newdd">
                                                <a data-toggle="tooltip" title="Report Download" href="exportcourse.php?uniqueid=<?php echo $_GET['uniqueid']; ?>&username=<?php echo $_SESSION['user_name']; ?>" class="btn btn-success"><i class="fa fa-download"></i>
                                                    Download</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">

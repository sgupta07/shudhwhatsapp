...
<head>
    ...
    if (isset($_POST['submit'])) {
        // message,mobileno,numbercount,wimage1,wimage2,wimage4,wimage5
        $User_ID = $_SESSION['User_ID'];
        $sql_payment_mst = "SELECT * FROM `user_details` where id='$User_ID' and wi !='' limit 1";
        ...
        if ($row1['wi'] >= $numbercount) {
            ...
            //$upload = $_POST['upload'];
            $wimage1 = '';
            if (isset($_FILES['wimage1'])) {
                $wimage1 = $_FILES['wimage1']['name'];
                $wimage1_temp = $_FILES['wimage1']['tmp_name'];
                move_uploaded_file($wimage1_temp, "wimages/$wimage1");
            }
            $wpdf = '';
            if (isset($_FILES['wimage2'])) {
                $wpdf = $_FILES['wimage2']['name'];
                $wpdf_temp = $_FILES['wimage2']['tmp_name'];
                move_uploaded_file($wpdf_temp, "wpdf/$wpdf");
            }
            // $waudio = '';
            // if (isset($_FILES['waudio'])) {
            //     $waudio = $_FILES['waudio']['name'];
            //     $waudio_temp = $_FILES['waudio']['tmp_name'];
            //     move_uploaded_file($waudio_temp, "waudio/$waudio");
            // }
            $wvideo = '';
            if (isset($_FILES['wimage4'])) {
                $wvideo = $_FILES['wimage4']['name'];
                move_uploaded_file(
                    $_FILES["wimage4"]["tmp_name"],
                    "upload/" . $_FILES["wimage4"]["name"]
                );
            }
            $dpimage = '';
            if (isset($_FILES['wimage5'])) {
            ...
            if ($conn->query($query) === TRUE) {
                ...
                $api_url2 = "http://sms.prateekiit.in/http-api.php?username=Prateekiit&password=12345&senderid=PRAIIT&route=06&number=7880091100&message=" . $sms_text . "&templateid=1207162885012838030";
                ...
                // die();
                echo "<script>alert ('SMS Send successfully'); window.location.href = 'dashboard.php';</script>";
            } else {
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="box box-body">
                                    <div class="col-md-6">
                                        <h4><i class="fa fa-pencil"></i> &nbsp; Send International</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div id="refresh7">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number"><?php echo $wi; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <div class="box-body ">
                                        ...
                                        <form id="fileinfo" action="./sendInternational.php" method="post" name="fileinfo" autocomplete="off" enctype="multipart/form-data" class="form-horizontal" onsubmit="$('#loading').show();">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group">
															 <?php
                                                            $total_count = 0;
                                                            $sql = "SELECT count(*) as total_count FROM i_send_whatsapp WHERE DATE(send_delivery_dateTime) = CURDATE() and userID='" . $_SESSION['User_ID'] . "'";
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group RadioVideo" style="background-color:#F5F5F5">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            <div class="col-md-12">
                                                                <input type="file" class="fileinput btn-primary" name="wimage4" id="video" data-filename-placement="inside" title="File name goes inside">

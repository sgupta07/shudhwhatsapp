                            ...
                            <div class="box-body table-responsive">
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT isw.*,ud.user_name as user_name FROM `b_send_whatsapp` as isw LEFT JOIN user_details AS ud ON ud.id=isw.userID order by isw.msg_id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="NewCReport">
                                                    <a data-toggle="tooltip" title="View More" href="admin-camp-button.php?action=view&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                                    ...
                                                    <a data-toggle="tooltip" title="Delete" href="admin-camp-button.php?action=delete&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>

                                        ...
                                        <div class="box-body table-responsive">
                                            <table id="example1" class="table table-bordered table-striped ">
                                                ...
                                                <tbody>
                                                 ...
                                                 //   $query = "SELECT * FROM `user_details` where user_type ='4' and creates_by='" . $_SESSION['User_ID'] . "'  order by id desc";
													if($_SESSION['user_type']==2){
														  $query = "SELECT * FROM `user_details` where user_type ='4' and sub_admin_id='" . $_SESSION['User_ID'] . "'  order by id desc";
													}else{
													  $query = "SELECT * FROM `user_details` where user_type ='4' and creates_by='" . $_SESSION['User_ID'] . "'  order by id desc";
													}
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="clientList">
                                                                ...
                                                                <a data-toggle="tooltip" title="Credit Update" href="user.php?action=credit&uniqueid=<?php echo $row['id']; ?>" class="btn btn-warning"><i class="fa fa-comment"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>

...
<body class="skin-green sidebar-mini" style="height: auto;">
                    ...
                    <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body campaign-view">
                                ...
                                $query = "SELECT sw.*,ud.user_name as user_name FROM `i_send_whatsapp` AS sw LEFT JOIN user_details  AS ud ON ud.id=sw.userID where sw.msg_id='" . $_GET['uniqueid'] . "' ";
                                ...
                                <div class="col-sm-6 border-left newfilter_table">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="newdd">
                                                <a data-toggle="tooltip" title="Report Download" href="export_int_camp_rept.php?uniqueid=<?php echo $_GET['uniqueid']; ?>&username=<?php echo $_SESSION['user_name']; ?>" class="btn btn-success"><i class="fa fa-download"></i>
                                                    Download</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
    ...
    margin-left: 6px;">Search
                                    ...
                                    <form action="int_cam_rept_status_change.php" method="post">
                                    ...
                                    <table id="" class="table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            ...
                                            $query1 = "SELECT * FROM `i_send_msg_details` where send_id='" . $_GET['uniqueid'] . "' ";

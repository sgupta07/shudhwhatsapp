                ...
                <div class="content-wrapper" style="min-height: 851px; padding: 15px;">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box box-body">
                                    <div class="col-md-12">
                                        <h4><i class="fa fa-list"></i> &nbsp; Check Campaign Logs </h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box" style="    padding: 15px 0px;">
                            ...
                            <div class="dataTables_filter dataTables_filter_new">
                                <form action="" method="post">
                                    <label>Unique ID *</label><input type="search" value="" name="uniqueid" class="form-control input-sm" placeholder="" aria-controls="datatable">
                                    <button class="btn btn-success data_search_sub" type="submit" name="submit" style="padding: 4px 7px;

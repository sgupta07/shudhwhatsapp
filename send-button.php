            ...
            <section id="main-content">
                ...
                <div class="content-wrapper" style="min-height: 851px; padding: 15px;">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="box box-body">
                                    <div class="col-md-6">
                                        <h4><i class="fa fa-pencil"></i> &nbsp; Send Button</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div id="refresh7">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number"><?php echo $wb; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <div class="box-body ">
                                        ...
                                        ?>
                                        <form id="fileinfo" action="./sendbutton.php" method="post" name="fileinfo" autocomplete="off" enctype="multipart/form-data" class="form-horizontal" onsubmit="$('#loading').show();">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group">
                                                            <?php
                                                            $total_count = 0;
                                                            $sql = "SELECT count(*) as total_count FROM b_send_whatsapp WHERE DATE(send_delivery_dateTime) = CURDATE() and userID='" . $_SESSION['User_ID'] . "'";
                                                            $select_data = mysqli_query($conn, $sql);
                                                            while ($row_count = mysqli_fetch_array($select_data)) {
                                                                $total_count = $row_count['total_count'];
                                                            }
                                                            ?>
                                                            <span style="font-size:12px;color:#b64645;text-align:left;"><b>Daily Testing Limit: <?php echo $total_count; ?> / 4</b></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style="margin-bottom:0px;">
                                                    <label class="col-md-3 control-label">Mobile Numbers
                                                        <br /> <span style="font-size:10px;color:#b64645;text-align:left;">Maximum
                                                            10,00,000</span>
                                                    </label>
                                                ...
                                                <div class="form-group">
                                                    <div class="">
                                                        ...
                                                        if ($total_count < 4) {
                                                        ?>
                                                            <button type="submit" id="button_send" name="submit" class="btn btn-success div_center"><i class="fa fa-floppy-o"></i> Submit
                                                            </button>

                                                        <?php
                                                        } else {
                                                        ?>
                                                            <p style="color:red;">Your daily limit is crossed</p>
                                                        <?php
                                                        }
                                                        ?>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group RadioVideo" style="background-color:#F5F5F5">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            <div class="col-md-12">
                                                                <input type="file" class="fileinput btn-primary" name="wvideo" id="video" data-filename-placement="inside" title="File name goes inside">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">
                                                        Call Now
                                                        <br> <span style="font-size:10px;color:#b64645;text-align:left;"></span>
                                                    </label>
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" class="fileinput" name="btn_call" id="btn_call" required placeholder="Enter Call Now No.">
                                                        <br /> <span id="mob_msg" style="font-size:10px;color:#b64645;text-align:left;visibility: hidden;">Number is not valid</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" class="fileinput" name="btn_link" id="btn_link" placeholder="Enter Visit Now Link" required autocomplete="off">
                                                        <br /> <span id="link_msg" style="font-size:10px;color:#b64645;text-align:left;visibility:hidden;">URL not valid</span>
                                                    </div>
                                                </div>
                    ...
                    <script>
                        ...
                        $("#send_w_button").addClass('active');

                        $('#btn_call').on("input", function() {
                            var btn_call = document.getElementById('btn_call');
                            // alert(btn_call);
                            var phoneno = /^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/;
                            if ((btn_call.value.match(phoneno))) {
                                // document.getElementById("button_send").style.display = "block";
                                // document.getElementById('mob_msg').style.display = 'block';
                                document.getElementById('mob_msg').style.visibility = 'hidden';
                                document.getElementById("button_send").style.visibility = "visible";
                                // document.getElementById("mob_msg").style.display = "none";
                            } else {
                                // document.getElementById("button_send").style.display = "none";
                                // document.getElementById("mob_msg").style.display = "block";
                                // document.getElementById('mob_msg').style.display='block';
                                document.getElementById('mob_msg').style.visibility = 'visible';
                        ...
                        $('#btn_link').on("input", function() {
                            var txturl = document.getElementById('btn_link');

                            var valid = txturl.value.match(/^(http(s)?:\/\/)[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&'\(\)\*\+,;=.]+$/);
                            // alert(valid);
                            if (valid == null) {
                                // document.getElementById("button_send").style.display = "none";
                                // document.getElementById("link_msg").style.display = "block";

                                document.getElementById('link_msg').style.visibility = 'visible';
                                document.getElementById("button_send").style.visibility = "hidden";
                            } else {
                                // document.getElementById("button_send").style.display = "block";
                                // document.getElementById("link_msg").style.display = "none";
                                document.getElementById('link_msg').style.visibility = 'hidden';

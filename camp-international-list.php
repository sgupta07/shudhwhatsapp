                            ...
                            <div class="box-body table-responsive">
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT isw.*,ud.user_name as user_name FROM `i_send_whatsapp` as isw LEFT JOIN user_details AS ud ON ud.id=isw.userID WHERE isw.userID='" . $_SESSION['User_ID'] . "' order by isw.msg_id DESC";

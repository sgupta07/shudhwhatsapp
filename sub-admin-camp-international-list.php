                                ...
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['uniqueid']) && $_GET['action'] == 'delete') {
                                            ...
                                            $query = "delete from `i_send_whatsapp` WHERE `msg_id`='$id'";
                                            ...
                                            $query = "delete from `i_send_msg_details` WHERE `send_id`='$id'";
                                            if ($conn->query($query) === TRUE) {
                                                //                 $last_id = $conn->insert_id; window.location.href = 'user_list.php';
                                                // echo "<script>alert ('Record Delete Successfully');</script>";
                                            } else {
                                        ...
                                        $query = "SELECT isw.*,ud.user_name as user_name FROM `i_send_whatsapp` as isw LEFT JOIN user_details AS ud ON ud.id=isw.userID WHERE ud.sub_admin_id='" . $_SESSION['User_ID'] . "' order by isw.msg_id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="NewCReport">
                                                    <a data-toggle="tooltip" title="View More" href="camp-international.php?action=view&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>

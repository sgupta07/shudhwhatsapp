                        ...
                        <div class="box">
                            ...
                            <div class="box-body table-responsive">
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        <?php
                                       $query = "SELECT sw.*,ud.user_name as user_name FROM `send_whatsapp` AS sw LEFT JOIN user_details  AS ud ON ud.id=sw.userID where ud.sub_admin_id='" . $_SESSION['User_ID'] . "' order by sw.msg_id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="NewCReport">
                                                    <a data-toggle="tooltip" title="View More" href="sub-admin-campaign-report.php?action=view&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>

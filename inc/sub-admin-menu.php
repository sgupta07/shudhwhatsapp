    ...
    <section class="sidebar">
        ...
        <div class="user-panel" style="height: 105px;">
            ...
            <div class="pull-left info">
                ...
                <a href="javascript:void(0);"><i class="fa fa-user text-success"></i> Sub Admin</a>
                <?php
    ...
    line-height: 14px;" href="javascript:void(0);"><i class="fa fa-paper-plane text-primary"></i> WB : <?php echo $wb;?></a>
      ...
      <!--  <ul class="sidebar-menu">
            <li id="c_report" class="treeview">
                <a href="sub-admin-campaign-report.php">
        ...
        <ul class="sidebar-menu">
            <li id="c_report_int" class="treeview">
                <a href="sub-admin-camp-international.php">
        ...
        <ul class="sidebar-menu">
            <li id="c_button_report_int" class="treeview">
                <a href="sub-admin-camp-button.php">
        ...
        <ul class="sidebar-menu">
            <li id="Campaign_logs" class="treeview">

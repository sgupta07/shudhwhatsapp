...
$sql1= "SELECT COUNT(*) as `count` FROM send_whatsapp WHERE DATE(send_delivery_dateTime) = CURDATE() and userID='" . $_SESSION['User_ID'] . "'";
$today_clients_data = mysqli_query($conn, $sql1);

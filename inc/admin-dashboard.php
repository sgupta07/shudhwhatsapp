...
$sql = "SELECT COUNT(*) as `count` FROM send_whatsapp";
$clients_data = mysqli_query($conn, $sql);
while ($row = mysqli_fetch_array($clients_data)) {
    $my_campaign++;
}

$sql = "SELECT COUNT(*) as `count` FROM send_whatsapp WHERE DATE(send_delivery_dateTime) = CURDATE()";
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $my_campaign; ?></span>
            </div>
        </div>
    </div>
    <!-- /.col -->
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $today_user_count; ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $today_reseller_count; ?></span>
            </div>
        </div>
    </div>

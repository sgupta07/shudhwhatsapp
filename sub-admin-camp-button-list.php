        ...
        <section id="container">
            ...
            <section id="main-content">
                ...
                <div class="content-wrapper" style="min-height: 851px; padding: 15px;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box box-body">
                                    <div class="col-md-4">
                                        <h4><i class="fa fa-list"></i> &nbsp; International Campaign Reports </h4>
                                    </div>
                                    <div class="col-md-8">
                                        <form action="exportreport-international.php" class="pull-right new_d_show" method="post">
                                            <input type="date" name="startdate1">
                                            <input type="date" name="enddate1">
                                            <button type="submit" class="btn btn-success" value="Download Excel"><i class="fa fa-download"></i> Download</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['uniqueid']) && $_GET['action'] == 'delete') {
                                            ...
                                            $query = "delete from `b_send_whatsapp` WHERE `msg_id`='$id'";
                                            ...
                                            $query = "delete from `b_send_msg_details` WHERE `send_id`='$id'";
                                            if ($conn->query($query) === TRUE) {
                                                //                 $last_id = $conn->insert_id; window.location.href = 'user_list.php';
                                                // echo "<script>alert ('Record Delete Successfully');</script>";
                                            } else {
                                        ...
                                        $query = "SELECT isw.*,ud.user_name as user_name FROM `b_send_whatsapp` as isw LEFT JOIN user_details AS ud ON ud.id=isw.userID WHERE ud.sub_admin_id='" . $_SESSION['User_ID'] . "' order by isw.msg_id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="NewCReport">
                                                    <a data-toggle="tooltip" title="View More" href="sub-admin-camp-button.php?action=view&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                                <a data-toggle="tooltip" title="Change Status" href="change-status-b.php?status=<?php echo $row['status']; ?>&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-check-circle"></i></a>

                                                    <a data-toggle="tooltip" title="Report Download" href="exportbutton.php?uniqueid=<?php echo $row['msg_id']; ?>&username=<?php echo $_SESSION['user_name']; ?>" class="btn btn-success"><i class="fa fa-download"></i></a>
                                                   <a data-toggle="tooltip" title="Delete" href="sub-admin-camp-button.php?action=delete&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                    ...
                    <script>
                        $("#c_button_report_int").addClass('active');
                    </script>
                    <script>

...
<body class="skin-green sidebar-mini" style="height: auto;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <div class="box-body ">
                                        <?php
                                        $query = "SELECT * FROM `user_details`  where user_type ='3' and id='" . $_GET['uniqueid'] . "' limit 1";
    ...
    width: 84%;" placeholder="Enter password" name="password" id="pwd" required value="<?php echo $row['password']; ?>">

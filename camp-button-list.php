        ...
        <section id="container">
            ...
            <section id="main-content">
                ...
                <div class="content-wrapper" style="min-height: 851px; padding: 15px;">
                            ...
                            <div class="box-body table-responsive">
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT isw.*,ud.user_name as user_name FROM `b_send_whatsapp` as isw LEFT JOIN user_details AS ud ON ud.id=isw.userID WHERE isw.userID='" . $_SESSION['User_ID'] . "' order by isw.msg_id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="NewCReport">
                                                    <a data-toggle="tooltip" title="View More" href="camp-button-report.php?action=view&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                              <!--      <a data-toggle="tooltip" title="Change Status" href="change-status-i.php?status=<?php echo $row['status']; ?>&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-check-circle"></i></a>-->
                                                 ...
                                                 <!--   <a data-toggle="tooltip" title="Delete" href=camp-international.php?action=delete&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>-->
                    ...
                    <script>
                        $("#c_report_button").addClass('active');
                    </script>
                    <script>

                                ...
                                <table id="example1" class="table table-bordered table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['uniqueid']) && $_GET['action'] == 'delete') {
                                            ...
                                            $query = "delete from `send_whatsapp` WHERE `msg_id`='$id'";
                                            ...
                                            $query = "delete from `send_msg_details` WHERE `send_id`='$id'";
                                            if ($conn->query($query) === TRUE) {
                                                //                 $last_id = $conn->insert_id; window.location.href = 'user_list.php';
                                                // echo "<script>alert ('Record Delete Successfully');</script>";
                                            } else {
                                        ...
                                        $query = "SELECT sw.*,ud.user_name as userName FROM `send_whatsapp` AS sw LEFT JOIN user_details  AS ud ON ud.id=sw.userID order by sw.msg_id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="NewCReport">
                                                    <a data-toggle="tooltip" title="View More" href="admin-campaign-report.php?action=view&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                                    <a data-toggle="tooltip" title="Change Status" href="change-status.php?status=<?php echo $row['status']; ?>&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-primary"><i class="fa fa-check-circle"></i></a>
                                                    ...
                                                    <a data-toggle="tooltip" title="Delete" href="admin-campaign-report.php?action=delete&uniqueid=<?php echo $row['msg_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>

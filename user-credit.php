...
<head>
    ...
    if (isset($_POST['creditsubmit'])) {
        ...
        while ($row = mysqli_fetch_array($select_data)) {
            ...
            $update_user1 = "UPDATE `user_details` SET `wn`=$user_wn,`wi`=$user_wi where id='$id'";
            mysqli_query($conn, $update_user1);
            $update_user2 = "UPDATE `user_details` SET `wn`=$wn,`wi`=$wi where id='" . $_SESSION['User_ID'] . "'";
            mysqli_query($conn, $update_user1);
            die();
        }
    }
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <!-- form start -->
                                    <div class="box-body ">
                                        <form id="fileinfo" action="./credit.php" method="post" name="fileinfo" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" required style="width: 100%;" placeholder="Enter no of sms" name="no_of_sms" value="">
                                                    </div>
                                                </div>

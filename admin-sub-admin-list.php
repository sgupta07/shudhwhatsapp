                                        ...
                                        <div class="box-body table-responsive">
                                            <table id="example1" class="table table-bordered table-striped ">
                                                ...
                                                <tbody> <?php
                                                        ...
                                                        $query = "SELECT user_details.*,ud.user_name as username FROM `user_details` left join user_details as ud on ud.id=user_details.creates_by where user_details.user_type ='2' order by user_details.id desc";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="clientList">
                                                                <a data-toggle="tooltip" title="Edit" href="admin-sub-admin.php?action=edit&uniqueid=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                                <a data-toggle="tooltip" title="Delete" href="admin-sub-admin.php?action=delete&uniqueid=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                                <a data-toggle="tooltip" title="Credit Update" href="admin-sub-admin.php?action=credit&uniqueid=<?php echo $row['id']; ?>" class="btn btn-warning"><i class="fa fa-comment"></i></a>

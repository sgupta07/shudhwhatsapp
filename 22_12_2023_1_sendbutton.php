...
include "./appcode/sendwhatsapp.php";
    ...
    if ($_POST['radioTabTest'] == 1) {
        if ($_FILES['wimage1']['size'] > 0) {
            ...
            if (isset($_FILES['wimage1']["name"])) {
                ...
                $media_url = "shudhwhatsapp.in/wimages/" . $wimage1;
                $media_name = $wimage1;
            }
                ...
                if ($numbercount <= 5) {
                    if ($mobile_no_count == 1) {
                        ...
                        if ($btn_call != "" || $btn_link != "") {
                            ...
                            $url = "https://app.whatzapi.com/api/send-call-to-action.php";
                            $data = [
                                "number" => $number,
                                "msg" => $msg,
                                "callbtn" => $btn_call,
                            ...
                            // $send_whatsapp->send_media_msg($number, $ins,$msg);

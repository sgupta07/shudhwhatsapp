...
<head>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sub_admin_id = 0;
        $query = "SELECT * FROM `user_details` where user_details.id ='$user_id'";
        ...
        $status = $_POST['status'];
        $sql = "INSERT INTO `user_details`(`company_name`, `user_name`, `full_name`, `mobile`, `email`, `password`, `user_profile`,`user_type`, `status`, `creates_by`, `sub_admin_id`, `created`)";
        $sql .= "VALUES ('$company','$username','$fullname','$mobileno','$email','$password','$user_profile','3','$status','$user_id',$sub_admin_id,now())";
        $insert_user = mysqli_query($conn, $sql);
        if (!$insert_user) {
            die('QUERY FAILD post' . mysqli_error($conn));
        } else {
            // alert('Reseller User Add successfully');
            echo "<script>  window.location.href = 'reseller.php?msg=1';";
            echo "</script>";
        }
    } ?>
...
<body class="skin-green sidebar-mini" style="height: auto;">
                ...
                <div class="content-wrapper" style="min-height: 851px; padding: 15px;">
                    <section class="content">
                        <div class="box box-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <h4><i class="fa fa-pencil"></i> &nbsp; Manage Reseller</h4>
                                </div>
                                <div class="col-md-4">
                                    <a href="javascript:history.back()" class="btn btn-primary pull-right"><i class="fa fa-close"></i> cancel</a>
                                    <a href="reseller.php?action=add" style="margin-right:5px;" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Reseller</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" style="width: 100%;" required placeholder="Enter fullname" name="fullname" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" onkeyup="return forceLower(this);" required style="width: 100%;" placeholder="Enter userName" name="username" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="email" onkeyup="return forceLower(this);" required style="width: 100%;" placeholder="Enter email id" name="email" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" style="width: 100%;" required placeholder="Enter mobileno" name="mobileno" value="">
                                                    </div>
                                                </div>
    ...
    width: 84%;" placeholder="Enter password" required name="password" id="pwd" value="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <input type="text" style="width: 100%;" placeholder="Enter company" name="company" value="">
                                                    </div>
                                                </div>

...
<head>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql_payment_mst = "SELECT * FROM `user_details` where id='$User_ID' and wn !='' limit 1";
        ...
        if ($row1['wn'] >= $numbercount) {
            ...
            if ($conn->query($query) === TRUE) {
                ...
                foreach ($mobileno as $mobilenos) {
                    $query = mysqli_query($conn, "INSERT INTO `send_msg_details`(`send_id`, `mobNumbar`, `status`) VALUES ('$last_id','$mobilenos','Submitted')");
                }

                echo "<script>window.location.href = 'dashboard.php';</script>"; //alert ('SMS Send successfully'); 
            } else {
                echo "Error: " . $query . "<br>" . $conn->error;
            }
        } else {
            echo "<script> window.location.href = 'dashboard.php';</script>"; //alert ('Insufficient balance');
        }
    }
    ?>
    <style>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="box box-body">
                                    <div class="col-md-6">
                                        <h4><i class="fa fa-pencil"></i> &nbsp; Send Whatapp</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <div class="box-body ">
                                        ...
                                        ?>
                                        <form id="fileinfo" action="./send-whatsapp.php" method="post" name="fileinfo" autocomplete="off" enctype="multipart/form-data" class="form-horizontal" onsubmit="$('#loading').show();">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group">
															 <?php
                                                            $total_count = 0;
                                                            $sql = "SELECT count(*) as total_count FROM send_whatsapp WHERE DATE(send_delivery_dateTime) = CURDATE() and userID='" . $_SESSION['User_ID'] . "'";

...
<head>
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "UPDATE `i_send_whatsapp` SET `status`='$change_status' WHERE `msg_id`='$uniqueid'";
        $update_status = mysqli_query($conn, $query);
        $query_msg = "UPDATE `i_send_msg_details` SET `status`='$change_status' WHERE `send_id`='$uniqueid'";

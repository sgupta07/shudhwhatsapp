...
<body class="skin-green sidebar-mini" style="height: auto;">
                    ...
                    <section class="content">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body campaign-view">
                                ...
                                $query = "SELECT sw.*,ud.user_name as user_name FROM `send_whatsapp` AS sw LEFT JOIN user_details  AS ud ON ud.id=sw.userID where sw.msg_id='" . $_GET['uniqueid'] . "' ";
    ...
    margin-left: 6px;">Search
                                    ...
                                    <form action="nt_cam_rept_status_change.php" method="post">
                                    ...
                                    <table id="" class="table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            ...
                                            $query1 = "SELECT * FROM `send_msg_details` where send_id='" . $_GET['uniqueid'] . "' ";

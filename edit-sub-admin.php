                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box">
                                    ...
                                    <div class="box-body ">
                                        <?php
                                        $query = "SELECT * FROM `user_details`  where user_type ='2' and id='" . $_GET['uniqueid'] . "' limit 1";
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-xs-12">
                                                            <input type="text" style="width: 100%;" required placeholder="Enter fullname" value="<?php echo $row['full_name']; ?>" name="fullname">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-xs-12">
                                                            <input type="text" onkeyup="return forceLower(this);" required style="width: 100%;" placeholder="Enter userName" value="<?php echo $row['user_name']; ?>" name="username">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9 col-xs-12">
                                                            <input type="text" style="width: 100%;" placeholder="Enter mobileno" required name="mobileno" value="<?php echo $row['mobile']; ?>">
                                                        </div>
                                                    </div>
